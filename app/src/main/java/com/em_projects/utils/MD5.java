...
public class MD5 {
    ...
    public static String getHashString(byte[] b) {
        try {
            ...
            //#ifdef ERROR
            Utils.error("MD5.getHashString() - failed to encode the string (" + new String(b) + "). Excpetion: " + e);
            //#endif
        }
...
//	}
    ...
    public static String getHashString(String s) {
        try {
            ...
            //#ifdef ERROR
            Utils.error("MD5.getHashString() - failed to encode the string (" + s + "). Excpetion: " + e);
            //#endif
        }
