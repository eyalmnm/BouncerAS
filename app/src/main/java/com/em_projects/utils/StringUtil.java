...
public class StringUtil {
    ...
    //holds boolean constants in string format
    public static final String STR_TRUE = "true";
    public static final String STR_FALSE = "false";
    //holds constant for empty string
...
//            return hexString.toString();
    ...
    public static final String toBase64(String text) throws UnsupportedEncodingException {
        ...
        char empryChar = "".charAt(0);
        String base64 = new String(Base64.encode(data)).trim().replace('\n', empryChar);
        return base64;
    }
    ...
    public static final String fromBase64(String base64) throws UnsupportedEncodingException {
        ...
        String text = new String(data, "UTF-8").trim().replace("\n", "");
        return text;
    }
